...
import questions from "../../questionshard.json";
import isEmpty from "../../utils/is-empty";

class HighPlay extends Component {
  constructor(props) {
    super(props);
    this.state = {
      questions,
        ...
        <div id="playquiz">
          ...
          <div className="questions">
            ...
            <div id="myinputs">
              ...
              <div>
                <button type="button" onClick={this.checkAnswer} id="myButton">
                  Predaj odgovor
                </button>
              </div>
            </div>
